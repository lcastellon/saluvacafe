...
CREATE UNIQUE INDEX pos_sucursales_nombre_idx ON public.pos_sucursales (lower(nombre));
...
VALUES ('Salúva Centro', '')
ON CONFLICT DO NOTHING;

ALTER TABLE public.pos_terminales
  ADD COLUMN sucursal_id uuid REFERENCES public.pos_sucursales(id);
...
CREATE UNIQUE INDEX pos_terminal_nombre_sucursal_idx
...
CREATE UNIQUE INDEX pos_una_caja_abierta_por_terminal_idx
