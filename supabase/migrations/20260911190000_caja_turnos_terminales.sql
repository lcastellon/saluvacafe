...
REVOKE ALL ON public.pos_terminales, public.pos_cajas FROM PUBLIC, anon, authenticated;
GRANT ALL ON public.pos_terminales, public.pos_cajas TO service_role;
