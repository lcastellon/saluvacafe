          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {visibles.map((p) => (
              <button
                ...
                className={`surface grain-top group cursor-pointer p-4 text-left transition-all hover:-translate-y-0.5 hover:border-foreground active:scale-[0.98] ${tocado === p.id ? "scale-[0.97] border-primary bg-primary/[0.07]" : ""}`}
              >
