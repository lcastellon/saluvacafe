...
import { DoodleTaza, DoodleBolsa, DoodleTicket } from "@/components/doodles";

const iconos = {
  "En preparación": DoodleTaza,
  Listo: DoodleTicket,
    ...
    >
      <div className="grid gap-4 lg:grid-cols-3">
        {columnas.map((col) => {
          ...
          const Icono = iconos[col];
          return (
            <section key={col} className="min-w-0">
              <div className="flex items-center justify-between gap-2 border-b-2 border-foreground px-1 pb-2">
              ...
              <div className="mt-3 space-y-3">
                {lista.map((p) => (
                  <article key={p.id} className="surface p-4 transition-colors hover:border-foreground">
